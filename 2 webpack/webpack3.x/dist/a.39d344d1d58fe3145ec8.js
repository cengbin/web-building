...
console.log('app1', __WEBPACK_IMPORTED_MODULE_1_lodash___default.a.chunk(['a', 'b', 'c', 'd'], 1)); // ['a'] ['b'] ['c'] ['d']

__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.app1').css('color', 'red');
});

console.log('app1', __WEBPACK_IMPORTED_MODULE_2__utils__["a" /* dataType */]([])); // Array
